...
export default function NavigationPlaceholder({
  ...
  useEffect(() => {
    ...
    if (isResolvingMenus) {
      speak(__("Loading navigation block setup options…", "foodblog16-plus"));
    }

    if (hasResolvedMenus) {
      speak(__("Navigation block setup options ready.", "foodblog16-plus"));
    }
  ...
  return (
    <>
      <Placeholder className="wp-block-foodblog16-plus-custom-navigation-placeholder">
        {
        ...
        <div
          ...
          className="wp-block-foodblog16-plus-custom-navigation-placeholder__controls"
        >
          <div className="wp-block-foodblog16-plus-custom-navigation-placeholder__actions">
            <div className="wp-block-foodblog16-plus-custom-navigation-placeholder__actions__indicator">
              <Icon icon={navigation} /> {__("Navigation", "foodblog16-plus")}
            </div>
            ...
            {canUserCreateNavigationMenus && (
              ...
              >
                {__("Start empty", "foodblog16-plus")}
              </Button>
            )}
          </div>
        </div>
