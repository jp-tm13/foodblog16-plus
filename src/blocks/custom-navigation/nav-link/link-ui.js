...
function LinkUIBlockInserter({ clientId, onBack }) {
  ...
  return (
    ...
    >
      <VisuallyHidden>
        <h2 id={dialogTitleId}>{__("Add block", "foodblog16-plus")}</h2>

        <p id={dialogDescriptionId}>
          {__("Choose a block to add to your Navigation.", "foodblog16-plus")}
        </p>
      </VisuallyHidden>
  ...
  return (
    ...
    >
      {!addingBlock && (
        ...
        >
          <VisuallyHidden>
            <h2 id={dialogTitleId}>{__("Add link", "foodblog16-plus")}</h2>
